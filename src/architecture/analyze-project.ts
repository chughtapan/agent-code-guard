...
import { normalizeArchitectureOptions } from "./options.js";
...
export function analyzeProjectArchitecture(options: ArchitectureOptions = {}): ArchitectureReport {
  const normalized = normalizeArchitectureOptions(options);
